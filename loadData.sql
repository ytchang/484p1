...
CAST(uu.DAY_OF_BIRTH AS INTEGER), uu.GENDER
...
FROM 
(
				keykholt.PUBLIC_USER_INFORMATION uu, 	CITIES cc
)
WHERE
(
...
FROM
(
	keykholt.PUBLIC_USER_INFORMATION uu, PROGRAMS pp
)
WHERE
(
...
(
	...
	CAST(tti.TAG_X AS NUMBER), 
	CAST(tti.TAG_Y AS NUMBER)
)
FROM
(
